...
|:-----------:|:-------:|:-------:|:--------------:|:--------------:|:-----------:|:-----------:|:---------:|
| 256 | 990 | 113 | 4,178.1 | 36.98 | 5,901.0 | 52.22 | **1.41x** |

#### ISL=10k/OSL=350 c=40

| Config | Avg ISL | Avg OSL | AutoDeploy TPS | AutoDeploy RPS | PyTorch TPS | PyTorch RPS | PyT vs AD |
|--------|:-------:|:-------:|:--------------:|:--------------:|:-----------:|:-----------:|:---------:|
| Standard config | 10000 | 350 | 1,416.5 | 4.05 | 1,999.5 | 5.71 | **1.41x** |

#### 结论

- **ISL=990/OSL=113 c=256**: PyTorch TPS/RPS 均快 **1.41x**。
- **ISL=10k/OSL=350 c=40**: PyTorch TPS/RPS 均快 **1.41x**。
- 122B 上 PyTorch 的优势比 35B 更大（35B 最高 1.30x，122B 达到 1.41x）。
