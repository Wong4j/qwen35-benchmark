...
#### ISL=1k/OSL=100 c=256

| Concurrency | Avg ISL | Avg OSL | AutoDeploy TPS | AutoDeploy RPS | PyTorch TPS | PyTorch RPS | PyT vs AD |
|:-----------:|:-------:|:-------:|:--------------:|:--------------:|:-----------:|:-----------:|:---------:|
| 256 | 990 | 113 | 4,178.1 | 36.98 | 5,166.8 | 51.67 | **1.24x** |

#### ISL=10k/OSL=350 c=40

| Config | Avg ISL | Avg OSL | AutoDeploy TPS | AutoDeploy RPS | PyTorch TPS | PyTorch RPS | PyT vs AD |
|--------|:-------:|:-------:|:--------------:|:--------------:|:-----------:|:-----------:|:---------:|
| Standard config | 10000 | 350 | 1,416.5 | 4.05 | 1,994.7 | 5.70 | **1.41x** |

#### 结论

- **ISL=1k/OSL=100 c=256**: PyTorch 快 **1.24x**，与 35B 的 1.30x 趋势一致。
- **ISL=10k/OSL=350 c=40**: PyTorch 快 **1.41x**，长序列场景优势更大（35B 是 1.26x）。
